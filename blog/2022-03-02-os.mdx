...
We want to make it easier to write IaSQL modules, reduce waiting times when provisioning infrastructure and add more functionality to the existing AWS services. The list of things we want to build into IaSQL is long, but we want to do it in the open with your feedback and help. Drop us a line on [Discord](https://discord.com/invite/machGGczea)!